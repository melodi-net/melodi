...
#define MELODI_USB_PICO_CONTROL_INTERFACE 0
#define MELODI_USB_PICO_CONTROL_CLASS 0x02
#define MELODI_USB_PICO_CONTROL_SUBCLASS 0x02
#define MELODI_USB_PICO_CONTROL_PROTOCOL 0x00
#define MELODI_USB_PICO_CONTROL_IN 0x81
#define MELODI_USB_PICO_CONTROL_MAX_PACKET 8
#define MELODI_USB_PICO_INTERFACE 1
#define MELODI_USB_PICO_CLASS 0x0a
#define MELODI_USB_PICO_SUBCLASS 0x00
#define MELODI_USB_PICO_PROTOCOL 0x00
#define MELODI_USB_PICO_IN 0x82
#define MELODI_USB_PICO_OUT 0x01
#define MELODI_USB_PICO_MAX_PACKET 64
